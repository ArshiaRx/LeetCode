...
Each problem folder typically follows:

`{question_id}-{title_slug}`

## Language Usage Analysis

A language distribution report is generated automatically:

- `leetcode/ANALYSIS.md` (human-readable)
- `leetcode/analysis.json` (machine-readable)
